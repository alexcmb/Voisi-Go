    ...
    return (
        <Layout>
            <div className="min-h-screen py-12 px-4 relative overflow-hidden bg-slate-50 dark:bg-slate-950 font-sans transition-colors duration-300">
                {/* Visual Blobs */}
                <div className="absolute top-10 left-10 w-72 h-72 bg-accent-200/20 rounded-full blur-3xl pointer-events-none animate-pulse"></div>
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="text-center mb-16">
                        <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-accent-500/10 border border-accent-500/20 text-accent-600 dark:text-accent-400 text-sm font-bold tracking-wide uppercase mb-4 animate-bounce">
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-6 md:p-10 shadow-xl mb-12 hover:shadow-2xl transition-all duration-300">
                        <div className="flex flex-col md:flex-row gap-8 items-center">
                            <div className="w-20 h-20 md:w-28 md:h-28 bg-secondary-100 dark:bg-secondary-950/40 rounded-3xl flex items-center justify-center text-4xl md:text-5xl shrink-0 shadow-lg shadow-secondary-500/10 border border-secondary-200 dark:border-secondary-950/20">
                                🛡️
                            </div>
                            <div>
                                <div className="inline-block px-3 py-1 rounded-full bg-secondary-50 dark:bg-secondary-950/30 text-secondary-600 dark:text-secondary-400 text-xs font-bold uppercase tracking-wider mb-2">
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl overflow-hidden shadow-lg mb-16">
                        ...
                        <div className="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                            <div className="grid grid-cols-3 p-4 font-bold text-slate-400 uppercase tracking-wider text-xs">
                                <div>Avantage</div>
                                <div>Standard</div>
                                <div className="text-accent-500">Premium 👑</div>
                            </div>
                            ...
                            <div className="grid grid-cols-3 p-4 text-slate-600 dark:text-slate-300">
                                ...
                                <div className="font-semibold text-secondary-600 dark:text-secondary-400">Totalement Supprimées 🚫</div>
                            </div>
                            <div className="grid grid-cols-3 p-4 text-slate-600 dark:text-slate-300">
                                <div className="font-medium">Visibilité dans le fil (Explore)</div>
                                <div>Normale</div>
                                <div className="font-semibold text-accent-500">Boostée (Lueur d'Or) ✨</div>
                            </div>
                            <div className="grid grid-cols-3 p-4 text-slate-600 dark:text-slate-300">
                                <div className="font-medium">Badge Premium de confiance</div>
                                <div>Non</div>
                                <div className="font-semibold text-accent-500">Oui, Badge 👑</div>
                            </div>
                            <div className="grid grid-cols-3 p-4 text-slate-600 dark:text-slate-300">
                                <div className="font-medium">Vérification de sécurité</div>
                                <div>Optionnelle</div>
                                <div className="font-semibold text-secondary-600 dark:text-secondary-400">Conseillée (Badge ✓ Offert)</div>
                            </div>
                        </div>
                    </div>

                    {/* Interactive Simulator Redirect Card */}
                    <div className="bg-gradient-to-br from-primary-600 to-primary-700 dark:from-slate-900 dark:to-slate-800 text-white rounded-3xl p-8 text-center shadow-xl border border-primary-500/20 relative overflow-hidden">
                        ...
                        <p className="text-primary-100 dark:text-slate-300 max-w-lg mx-auto mb-6 text-sm md:text-base leading-relaxed">
                            {isPremium 
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <Link
                                to="/profile"
                                className="px-6 py-3 bg-white text-primary-700 hover:bg-slate-50 text-sm font-bold rounded-xl shadow-md transition transform hover:-translate-y-0.5"
                            >
                                {isPremium ? "Gérer mon compte & ID" : "Activer Premium & Vérifier mon identité"}
                            </Link>
                            <Link
                                to="/explore"
                                className="px-6 py-3 bg-primary-500/30 hover:bg-primary-500/50 text-white text-sm font-bold rounded-xl transition border border-white/10"
                            >
