        ...
        <Layout showHeader={true} showFooter={true}>
            <div className="flex items-center justify-center min-h-[70vh] p-6 text-center">
                <div className="max-w-md w-full glass-panel rounded-3xl p-8 shadow-glass animate-in border border-gray-200/50">
                    ...
                    <Link
                        to="/"
                        className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-primary-600 hover:bg-primary-700 text-white font-bold transition-all shadow-md transform hover:scale-[1.02] active:scale-[0.98]"
                    >
                        🏠 Retour à la maison
                    </Link>
                </div>
